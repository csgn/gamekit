...
#ifndef GAMEKIT_INCLUDE_GAMEKIT_CORE_EC_IBEHAVIOUR_H
#define GAMEKIT_INCLUDE_GAMEKIT_CORE_EC_IBEHAVIOUR_H
...
#endif // GAMEKIT_INCLUDE_GAMEKIT_CORE_EC_IBEHAVIOUR_H
